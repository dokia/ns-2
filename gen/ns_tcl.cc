...
\"\n\
checkout_executable TCLSH \"/home/kdong/ns-allinone-2.35/bin/tclsh8.5\" tclsh \"\\\n\
When configured, ns found the right version of tclsh in\\\n\
/home/kdong/ns-allinone-2.35/bin/tclsh8.5\n\
but it doesn't seem to be there anymore, so\\\n\
...
\n\
\n\
Application/DashAppClient set seqno 1\n\
Application/DashAppClient set bytes 0\n\
Application/DashAppClient set seglength 1\n\
Application/DashAppClient set segnumber 0\n\
Application/DashAppClient set playtime 0\n\
Application/DashAppClient set buffer 0\n\
Application/DashAppClient set pause_thre_ 3\n\
Application/DashAppClient set rebu_thre_ 3.0\n\
\n\
Application/DashAppServer set segnumber 0\n\
Application/DashAppServer set segmentNo 0\n\
Application/DashAppServer set bitrate 200\n\
Application/DashAppServer set dataType 200\n\
Application/DashAppServer set seglength 1\n\
\n\
\n\
...
\n\
Mac/802_11 set frame_loss_ratio_ 0.0\n\
\n\
